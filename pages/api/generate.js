...
タイトルは必ず次のフォーマットで記述してください：

タイトル："〇〇〇" 
※タイトルの中身は情景や感情などいい感じに
※「タイトル：」という語から始めて、全体を""で囲み、1行で記載してください。
※これを守らないと診断結果が保存されません。
...
- 文字数はSceneごとに500文字程度、セリフ中心でテンポよく
...
これらをふまえ、読者が自然に惹かれるような全3シーンの恋愛ストーリーを生成してください。
  `.trim();
